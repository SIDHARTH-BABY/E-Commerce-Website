...
module.exports = {
  ...
  view_order:async(req, res)=> {
    ...
    res.render('admin/view-order',{singleOrder,singleId})
  },

  item_packed:async(req, res)=> {
